...
export interface ApiAboutHistoryTimelineAboutHistoryTimeline
  extends Struct.CollectionTypeSchema {
  collectionName: 'about_histories';
  info: {
    description: 'Company history timeline for the about page';
    displayName: 'About History Timeline';
    pluralName: 'about-history-timelines';
    singularName: 'about-history-timeline';
  };
  options: {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['founding', 'growth', 'product', 'award', 'expansion', 'other']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::about-history-timeline.about-history-timeline'
    > &
      Schema.Attribute.Private;
    milestone: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiAboutInfoAboutInfo extends Struct.CollectionTypeSchema {
  collectionName: 'about_infos';
  info: {
    description: 'Main about page information content';
    displayName: 'About Info';
    pluralName: 'about-infos';
    singularName: 'about-info';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiAboutStatAboutStat extends Struct.CollectionTypeSchema {
  collectionName: 'about_stats';
  info: {
    description: 'Statistics and numbers for the about page';
    displayName: 'About Stat';
    pluralName: 'about-stats';
    singularName: 'about-stat';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiAboutTeamAboutTeam extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Team members for the about page';
...
export interface ApiHomeCarouselHomeCarousel
  ...
  info: {
    description: 'Manage carousel items for the homepage';
...
export interface ApiHomeContentHomeContent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'General content blocks for the homepage';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    jsonContent: Schema.Attribute.JSON;
    layout: Schema.Attribute.Enumeration<
      ['full-width', 'container', 'two-column', 'grid']
    > &
...
export interface ApiHomeProductListingHomeProductListing
  extends Struct.CollectionTypeSchema {
  collectionName: 'home_product_listings';
  info: {
    description: 'Product listings displayed on the homepage';
    displayName: 'Home Product Listing';
    pluralName: 'home-product-listings';
    singularName: 'home-product-listing';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-product-listing.home-product-listing'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiHomeTextHomeText extends Struct.CollectionTypeSchema {
  collectionName: 'home_texts';
  info: {
    description: 'Text content sections for the homepage';
    displayName: 'Home Text Section';
  ...
  attributes: {
    ...
    section: Schema.Attribute.Enumeration<
      ['hero', 'about', 'features', 'testimonial', 'cta']
    > &
      Schema.Attribute.Required &
...
export interface ApiHomeVideoHomeVideo extends Struct.CollectionTypeSchema {
  collectionName: 'home_videos';
  info: {
    description: 'Video content for the homepage';
  ...
  attributes: {
    ...
    provider: Schema.Attribute.Enumeration<
      ['youtube', 'vimeo', 'custom', 'wistia']
    >;
    publishedAt: Schema.Attribute.DateTime;
    section: Schema.Attribute.Enumeration<
      ['hero', 'featured', 'gallery', 'testimonial']
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-history-timeline.about-history-timeline': ApiAboutHistoryTimelineAboutHistoryTimeline;
